...
// AdminDashboard renders admin dashboard template
...
// AdminNewReservations shows all new reservations (processed reservations) in admin tool
...
// AdminShowReservations shows reservation in admin tool
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		//	that does not exist in out posted data , and if the restriction id > 0 , then it is a block we need to remove.
